...
namespace kbi_monitor
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load( object sender , EventArgs e )
        {
            ...
            server = new TCPServer_K( ip , 5000 );
            server.TalkingComm += server_TalkingComm;
        ...
        //evvvvvvvv
        void server_TalkingComm( string name , object data , int length )
        {
            if ( name.Equals( "Data" ) )
            {
                ...
                string[ ] comm_data = new string[ 16 ];

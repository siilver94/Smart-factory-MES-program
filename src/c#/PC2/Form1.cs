...
namespace KB_Data_V2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            sql = new Mysql_K("127.0.0.1", "kb_metal_3", "table1", "a", "qwerasdf");
        ...
        private int BarcodeCheck33(string bcr, string columnsname)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)//해당 바코드 찾았다.
            {
                ...
                for (int i = 0; i < cnt; i++)//그 컬럼 수 안에 OK수량 계산
                {
                    if (ds.Tables[0].Rows[0][i].ToString().Equals("OK"))//OK 카운트해라.
                        okcnt++;
        ...
        private void simpleButton11_Click_1(object sender, EventArgs e)
        {
            ...
            string MdateS = dateTimePicker1.Value.ToShortDateString();
            string MdateE = dateTimePicker2.Value.ToShortDateString();
            ////전체
            if (radioButton7.Checked)
            {
                ...
                string cmd = "SELECT barcode1, Datetime, Model,c19,c20,c21,c30,c31,c32,c33 FROM table1 WHERE barcode1 LIKE 'm%' AND DATE(DATETIME) BETWEEN '" + MdateS + "' and '" + MdateE + "';";
            ...
            else if (radioButton5.Checked)
            {
                ...
                string cmd = "SELECT barcode1, Datetime, Model,c19,c20,c21,c30,c31,c32,c33 FROM table1 WHERE barcode1 LIKE 'mb%' AND DATE(DATETIME) BETWEEN '" + MdateS + "' and '" + MdateE + "';";
            ...
            else if (radioButton6.Checked)
            {
                ...
                string cmd = "SELECT barcode1, Datetime, Model,c19,c20,c21,c30,c31,c32,c33 FROM table1 WHERE barcode1 LIKE 'mp%' AND DATE(DATETIME) BETWEEN '" + MdateS + "' and '" + MdateE + "';";
                sql.Select(dgvMT0, cmd, false);
        ...
        //마스터에서 컬럼 헤더 클릭 후 정렬시 OK/NG 색깔 입히기.
        private void dgvMT0_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            GridMaster.Color_Painting(dgvMT0, 3);
            GridMaster.Color_Painting(dgvMT0, 6);
